...
#include "Characters/Animation/VTAnimNotify_PlaySoundForPerspective.h"
...
UVTAnimNotify_PlaySoundForPerspective::UVTAnimNotify_PlaySoundForPerspective()
{
	bPlayForFirstPersonPerspective = true;
}

void UVTAnimNotify_PlaySoundForPerspective::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	if (SoundToPlay)
	{
		...
		AVTHeroCharacter* OwningHero = Cast<AVTHeroCharacter>(MeshComp->GetOwner());
