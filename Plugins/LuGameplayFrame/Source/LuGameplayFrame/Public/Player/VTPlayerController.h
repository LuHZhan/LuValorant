...
public:
	...
	*/
	...
	void ShowDamageNumber(float DamageAmount, AVTCharacterBase* TargetCharacter, FGameplayTagContainer DamageNumberTags);
	void ShowDamageNumber_Implementation(float DamageAmount, AVTCharacterBase* TargetCharacter, FGameplayTagContainer DamageNumberTags);
	bool ShowDamageNumber_Validate(float DamageAmount, AVTCharacterBase* TargetCharacter, FGameplayTagContainer DamageNumberTags);
...
protected:
	...
	TSubclassOf<class UVTHUDWidget> UIHUDWidgetClass;

	UPROPERTY(BlueprintReadWrite, Category = "GASShooter|UI")
	class UVTHUDWidget* UIHUDWidget;
