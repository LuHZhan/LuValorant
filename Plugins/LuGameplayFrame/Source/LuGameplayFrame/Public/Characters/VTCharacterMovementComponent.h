...
#include "VTCharacterMovementComponent.generated.h"
...
class GASSHOOTER_API UVTCharacterMovementComponent : public UCharacterMovementComponent
{
	...
	class FVTSavedMove : public FSavedMove_Character
	{
	public:
	...
	class FVTNetworkPredictionData_Client : public FNetworkPredictionData_Client_Character
	{
	public:
		FVTNetworkPredictionData_Client(const UCharacterMovementComponent& ClientMovement);
