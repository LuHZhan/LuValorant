...
#include "VTAttributeSetBase.generated.h"
 ...
 */
UCLASS()
class LUGAMEPLAYFRAME_API UVTAttributeSetBase : public UAttributeSet
{
	GENERATED_BODY()
...
public:
	...
	ATTRIBUTE_ACCESSORS(UVTAttributeSetBase, Health)

	// MaxHealth is its own attribute since GameplayEffects may modify it
	UPROPERTY(BlueprintReadOnly, Category = "Health", ReplicatedUsing = OnRep_MaxHealth)
	FGameplayAttributeData MaxHealth;
	ATTRIBUTE_ACCESSORS(UVTAttributeSetBase, MaxHealth)

	// Health regen rate will passively increase Health every second
	UPROPERTY(BlueprintReadOnly, Category = "Health", ReplicatedUsing = OnRep_HealthRegenRate)
	FGameplayAttributeData HealthRegenRate;
	ATTRIBUTE_ACCESSORS(UVTAttributeSetBase, HealthRegenRate)

	// Current Mana, used to execute special abilities. Capped by MaxMana.
	UPROPERTY(BlueprintReadOnly, Category = "Mana", ReplicatedUsing = OnRep_Mana)
	FGameplayAttributeData Mana;
	ATTRIBUTE_ACCESSORS(UVTAttributeSetBase, Mana)

	// MaxMana is its own attribute since GameplayEffects may modify it
	UPROPERTY(BlueprintReadOnly, Category = "Mana", ReplicatedUsing = OnRep_MaxMana)
	FGameplayAttributeData MaxMana;
	ATTRIBUTE_ACCESSORS(UVTAttributeSetBase, MaxMana)
	...
	ATTRIBUTE_ACCESSORS(UVTAttributeSetBase, ShieldRegenRate)
	...
	ATTRIBUTE_ACCESSORS(UVTAttributeSetBase, MoveSpeed)

	UPROPERTY(BlueprintReadOnly, Category = "Character Level", ReplicatedUsing = OnRep_CharacterLevel)
	FGameplayAttributeData CharacterLevel;
	ATTRIBUTE_ACCESSORS(UVTAttributeSetBase, CharacterLevel)
	...
	ATTRIBUTE_ACCESSORS(UVTAttributeSetBase, XP)
	...
	ATTRIBUTE_ACCESSORS(UVTAttributeSetBase, XPBounty)
	...
	ATTRIBUTE_ACCESSORS(UVTAttributeSetBase, Gold)
	...
	ATTRIBUTE_ACCESSORS(UVTAttributeSetBase, GoldBounty)
