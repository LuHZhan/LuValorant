...
#include "VTAbilitySystemComponent.generated.h"
...
public:
	...
	static UVTAbilitySystemComponent* GetAbilitySystemComponentFromActor(const AActor* Actor, bool LookForComponent = false);
